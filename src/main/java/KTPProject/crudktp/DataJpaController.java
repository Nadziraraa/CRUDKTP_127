...
import KTPProject.crudktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("KTPProject_crudktp_jar_0.0.1-SNAPSHOTPU");
